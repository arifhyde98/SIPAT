...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h4 fw-semibold mb-1">Master Kepala Desa</h1>
        <small class="text-muted">Daftar kepala desa dan status aktif.</small>
    </div>
</div>
...
<div class="row g-3">
    <div class="col-lg-5">
        <div class="card border-0 fancy-card">
            <div class="card-body">
                <form method="post" action="<?= base_url('master/kepala-desa') ?>">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" name="aktif" id="aktifKepala" checked>
                        <label class="form-check-label" for="aktifKepala">Aktif</label>
                    </div>
                            ...
                            <?php foreach ($rows as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form method="post" action="<?= base_url('master/kepala-desa/delete/' . $row['id']) ?>" data-confirm="Hapus data ini?">
                                            <?= csrf_field() ?>
