    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h5 class="modal-title">Edit Aset Tanah</h5>
                    <small class="text-muted">Perbarui data aset</small>
                </div>
                ...
                <form action="<?= base_url('aset/' . $aset['id_aset']) ?>" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="alamat" class="form-control" rows="3"><?= old('alamat', $aset['alamat']) ?></textarea>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="keterangan" class="form-control" rows="2" placeholder="Keterangan tambahan aset..."><?= old('keterangan', $aset['keterangan'] ?? '') ?></textarea>
                        </div>
                    </div>
