        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-header bg-primary-subtle border-bottom px-4 py-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold text-dark mb-0">Tambah Aset Tanah Baru</h5>
            ...
            <div class="modal-body p-4">
                ...
                <form action="<?= base_url('aset') ?>" method="post" id="formCreateAset" onsubmit="handleFormSubmit(this)">
                    <?= csrf_field() ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kode_aset" class="form-control form-control-soft" placeholder="Contoh: 12.01.02.01.001" value="<?= old('kode_aset') ?>" required>
                                </div>
                            </div>
                            <div class="col-md-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_aset" class="form-control form-control-soft" placeholder="Nama aset tanah..." value="<?= old('nama_aset') ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="peruntukan" class="form-control form-control-soft" placeholder="Contoh: Kantor Kecamatan / Lapangan" value="<?= old('peruntukan') ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="luas" class="form-control form-control-soft" placeholder="0.00" value="<?= old('luas') ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tanggal_perolehan" class="form-control form-control-soft" value="<?= old('tanggal_perolehan') ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="harga_perolehan" class="form-control form-control-soft" placeholder="0" value="<?= old('harga_perolehan') ?>">
                                </div>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="dasar_perolehan" class="form-control form-control-soft" placeholder="Contoh: Hibah / Pembelian APBD / SK Bupati..." value="<?= old('dasar_perolehan') ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-light border-0 rounded-3 p-3 mb-3">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="alamat" class="form-control form-control-soft" rows="2" placeholder="Jalan, Desa/Kelurahan, Kecamatan..."><?= old('alamat') ?></textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="lat" class="form-control form-control-soft" placeholder="-0.xxxxxx" value="<?= old('lat') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-white text-muted"><i class="bi bi-pin-map"></i></span>
                                    <input type="text" name="lng" class="form-control form-control-soft" placeholder="119.xxxxxx" value="<?= old('lng') ?>">
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold text-secondary">Keterangan Tambahan</label>
                                <textarea name="keterangan" class="form-control form-control-soft" rows="2" placeholder="Catatan fisik tanah, batas-batas, atau kondisi saat ini..."><?= old('keterangan') ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 pt-2 border-top">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4 fw-semibold shadow-sm" id="btnSubmitForm">
